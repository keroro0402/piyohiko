...
````
/* m_category にデータ登録 */
INSERT INTO m_category (category_title, catch_phrase)
VALUES
    ('API', 'APIに関するカテゴリ'),
    ('UI',  'UIに関するカテゴリ');
/* t_topic にデータ登録 */
INSERT INTO t_topic (category_id, user_id, registration_date, topic_title, topic_content)
VALUES
    (1, 'sasaki',   '2025-12-01', 'Spring Bootのコントローラ', 'コントローラに関する記事です'),
    (1, 'yamada',   '2023-01-05', 'Spring Bootのサービス',    'サービスに関する記事です'),
    (2, 'takiuchi', '2024-10-13', 'Vue3のデータバインディング', 'データバインディングに関する記事です'),
    (2, 'nanami',   '2025-01-29', 'Nuxtのルーティング',        'Nuxtのページルーティングに関する記事です');
 ````
3. 以下のコマンドで、 テーブル の データ 登録を確認する
````
...
### 達成条件
表示された テーブル に データ が登録されていること
````
+-------------+----------------+-----------------------------+
| category_id | category_title | catch_phrase                |
+-------------+----------------+-----------------------------+
|           1 | API            | APIに関するカテゴリ            |　<-- 登録したデータ
|           2 | UI             | UIに関するカテゴリ             |　<-- 登録したデータ
+-------------+----------------+-----------------------------+
````